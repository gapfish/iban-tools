  ...
  describe Conversion do
    ...
    describe '::local2iban' do
      context 'given valid data' do
        ...
        it 'returns valid CH IBAN with leading BANK_CODE zero' do
          iban = Conversion.local2iban('CH',
            :bank_code => '0226', :account_number => '22684897640Z')
          iban.should be_valid_check_digits
          iban.check_digits.should eq('97')
        end

        it 'returns valid CH IBAN without leading BANK_CODE zero' do
          iban = Conversion.local2iban('CH',
            :bank_code => '226', :account_number => '22684897640Z')
          iban.should be_valid_check_digits
          iban.check_digits.should eq('97')
        end
